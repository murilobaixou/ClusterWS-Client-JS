var ClusterWS = function() {
    ...
    return function() {
        ...
        r.prototype.send = function(t, n, o) {
            void 0 === o && (o = "emit"),
            n = this.options.encodeDecodeEngine ? this.options.encodeDecodeEngine.encode(n) : n,
        ...
        r.prototype.create = function() {
            var e = this;
            this.websocket = new i(this.options.url),
            this.websocket.binaryType = "arraybuffer",
            this.websocket.onopen = function() {
                e.reconnectionAttempted = 0;
                for (var t = 0, n = Object.keys(e.channels), o = n.length; t < o; t++)
                    e.channels.hasOwnProperty(n[t]) && e.channels[n[t]].subscribe()
            }
            ,
            ...
            this.websocket.onmessage = function(n) {
                ...
                if (57 === o[0])
                    return e.websocket.send(e.pong),
                    e.resetPing();
                try {
                    !function(t, e) {
                        var n = t.options.encodeDecodeEngine ? t.options.encodeDecodeEngine.decode(e["#"][2]) : e["#"][2]
                          , o = {
                            e: function() {
                        ...
                        for (var e = "", n = 65535, o = t.length, s = 0; s < o; s += n)
                            s + n > o && (n = o - s),
